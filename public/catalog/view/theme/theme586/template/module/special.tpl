							...
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="cart-button">
										<button class="btn btn-add" type="button"  data-toggle="tooltip" data-placement="bottom" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="material-design-shopping232"></i></button>
